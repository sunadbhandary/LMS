		...
		<div class="row-fluid">
			<div class="span2">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="#" data-toggle="tab"><b>Suggestion Box</b></a></li><br/>
					</ul>
				</div>
			...
			<div class="span10">
				<div class="tab-content">
							...
							<p style="font-size:22px;">&nbsp;Provide Feedback</p>
							<hr/>
							<div id="indent-block">
							<form action="savesuggestion.php" method="post">
							Write your suggestions here..<br />
							<textarea name="suggestion" rows="10" columns="500"></textarea>
							<br />
							<input id="subbutton" type="submit" value="Submit" class="btn btn-success" ><br/>
							</form>
