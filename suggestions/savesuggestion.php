	...
	<div class="container-fluid">
		<div class="row-fluid">
			<div class="span2">
				<div class="well sidebar-nav">
					<ul class="nav nav-list">
						...
						<li class="active"><a href="suggest.php" data-toggle="tab"><b>Suggestion Box</b></a></li><br/>
					</ul>
				</div>
			...
			<div class="span10">
				...
				{
					echo "<span style=\"font-size:22px;\">Please ensure that you have written your suggestion !!</span>";
					die();
				}
				else
				{
					$sql = "INSERT INTO `suggestions`(`user_id`, `date`, `suggestion`) VALUES ('$user->Card_Number' , '$today' , '$_POST[suggestion]')";
					if(!$db->query ($sql))
					{
						echo "<span style=\"font-size:22px;\">Dear user, this suggestion has already been received from you."."<br/>"."Thanks for your valuable inputs !!</span>";
						die();
					}
					else
					{
						echo "<span style=\"font-size:22px;\">Thanks for your valuable inputs !!</span>";
					}
				}
