						...
						<div class="lead">
							...
							<table border="0">
								...
								<tr>
									...
									<td>
										<input type="text" name="authors" maxlength=100><br />
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="edition" maxlength=10><br />
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<input type="text" name="publisher" maxlength=100><br />
									</td>
								</tr>
							...
							<br/>
							<label>Why do you think you want this book..</label>
							
							<textarea id="feedbackText" name="feedback" maxlength=500></textarea>
							<br />
