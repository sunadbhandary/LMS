						...
						<div class="lead margin">
							<table border="0" cellpadding="5">
								...
								<form action="issued.php" method="POST">
									...
									<td> <input name="Card_Number" type="text" value=""></td>
									<td><p style="font-size:14px;position:relative;left:5px;bottom:-15px;"><small>&nbsp;*required&nbsp;&nbsp;&nbsp;&nbsp;</small></p>&nbsp;</td>
									<td style="position:relative;float:right;bottom:-10px;left:60px;"><input type="submit" class="btn btn-primary" name="submit" value="Enter&nbsp;&raquo;"/>  </td>
								</form>
								</tr>
